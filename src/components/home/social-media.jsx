    ...
    <section className="py-16 px-4 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        {cards.map((card, index) => (
          ...
          >
            <div className={`w-12 h-12 rounded flex items-center justify-center`}> <img src={card.icon} alt="" /> </div>
            <div className='flex flex-col gap-2'>
              <h3 className="font-semibold text-sm text-gray-900 mb-1 uppercase">
                {card.title}
              </h3>
