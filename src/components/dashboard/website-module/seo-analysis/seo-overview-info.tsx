...
const SeoOverviewInfo: React.FC<seoOverviewSectionProps> = ({
  ...
  console.log('====priority number4444', priorityNumber);
  return (
      ...
      >
        ...
        <div className="flex-grow w-full md:w-3/4 text-center md:text-left">
          <div className="flex justify-between ">
            <div>
              <h2 className="text-[18px] font-semibold text-gray-900  mb-0">{type} report for</h2>
          ...
          {priorityNumber && priorityNumber !== undefined ? (<>
            <p className="text-gray-700 text-[14px] leading-[22px] mb-2">
              This website received {' '}
              <span className="font-semibold text-gray-900 ">{type} score of {seoScore} out of 100</span>
              , which is {`${seoScore > 75 ? 'higher than' : 'lower than'}`} the average score of 75.
              Our analysis has identified {priorityNumber.high + priorityNumber.medium + priorityNumber.low} important issues that can be addressed to further
            ...
            <p className="text-gray-700 text-[14px] leading-[22px] mb-2">
              ...
              <span className="font-semibold text-gray-900 ">{type} score of {seoScore} out of 100</span>
              , which is {`${seoScore > 75 ? 'higher than' : 'lower than'}`} the average score of 75.
              Our analysis has identified some important issues that can be addressed to further
              enhance your website's performance and improve its search engine visibility.
            </p>
          )}
        </div>
