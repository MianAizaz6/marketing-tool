...
interface SeoOverviewInfoProps {
  websiteUrl: string;

}

const SeoOverviewInfo: React.FC<SeoOverviewInfoProps> = ({
  websiteUrl,
    ...
    <div className="font-sans antialiased bg-gray-50 ">
      ...
      ">
        ...
        <div className="flex-grow w-full md:w-3/4 text-center md:text-left">
          <h2 className="text-[18px] font-semibold text-gray-900  mb-0">
            Audit report for
          </h2>
          <p className="text-[12px] text-gray-600 mb-1">
            Reported created on: <span className="font-medium">{'10, April 2025'}</span>
          </p>
          <a
          ...
          <p className="text-gray-700 text-[14px] leading-[22px] mb-2">
            This website received an <span className="font-semibold text-gray-900 ">SEO score of {'91'} out of 100</span>, which is higher than the average score of {'75'}. Our analysis has identified {'14'} important issues that can be addressed to further enhance your website's performance and improve its search engine visibility.
          </p>
